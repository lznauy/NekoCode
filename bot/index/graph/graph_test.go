...
func TestRemoveNode(t *testing.T) {
	...
	if g.EdgeFromCount(n1.ID) != 1 {
		t.Errorf("EdgeFromCount(n1) = %d, want 1", g.EdgeFromCount(n1.ID))
	}
	if g.EdgeToCount(n3.ID) != 1 {
		t.Errorf("EdgeToCount(n3) = %d, want 1", g.EdgeToCount(n3.ID))
	}
