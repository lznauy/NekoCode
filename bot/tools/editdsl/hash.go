// Package hashline implements a hashline-based file editing system.
// It provides file-level content hashing, a structured patch DSL parser,
// edit application with automatic boundary repair, and 3-way merge recovery.
package editdsl
