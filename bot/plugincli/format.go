...
func FormatInstallPreview(p *plugin.Plugin) string {
...
func FormatInstallResult(p *plugin.Plugin) string {
	var sb strings.Builder
...
func FormatList(plugins []*plugin.Plugin) string {
	if len(plugins) == 0 {
...
func FormatInfo(p *plugin.Plugin) string {
	var sb strings.Builder
