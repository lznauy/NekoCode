...
func TestSaveNodeAndLoadGraph(t *testing.T) {
	...
	n := &Node{ID: 1, Name: "foo", Kind: KindFunc, File: "a.go", Line: 10, EndLine: 20, PkgPath: "main", Signature: "func foo()", Doc: "// foo does stuff", Visibility: "public"}
	...
	loaded := g.Nodes[1]
	if loaded.Name != "foo" || loaded.Kind != KindFunc || loaded.Line != 10 || loaded.PkgPath != "main" {
...
func TestSaveNodeUpsert(t *testing.T) {
	...
	n := &Node{ID: 1, Name: "foo", Kind: KindFunc, File: "a.go", Line: 1}
	db.SaveNode(n)

	// Update same ID
	n2 := &Node{ID: 1, Name: "bar", Kind: KindStruct, File: "b.go", Line: 5}
	db.SaveNode(n2)
...
func TestSaveEdgeAndLoadGraph(t *testing.T) {
	...
	db.SaveNode(&Node{ID: 1, Name: "a", Kind: KindFunc, File: "a.go", Line: 1})
	db.SaveNode(&Node{ID: 2, Name: "b", Kind: KindFunc, File: "a.go", Line: 5})
	db.SaveEdge(&Edge{ID: 1, FromID: 1, ToID: 2, Kind: EdgeCalls, File: "a.go", Line: 3})
	...
	e := g.Edges[1]
	if e.FromID != 1 || e.ToID != 2 || e.Kind != EdgeCalls {
...
func TestDeleteFile(t *testing.T) {
	...
	db.SaveNode(&Node{ID: 1, Name: "a", Kind: KindFunc, File: "a.go", Line: 1})
	db.SaveNode(&Node{ID: 2, Name: "b", Kind: KindFunc, File: "a.go", Line: 5})
	db.SaveNode(&Node{ID: 3, Name: "c", Kind: KindFunc, File: "b.go", Line: 1})
	db.SaveEdge(&Edge{ID: 1, FromID: 1, ToID: 2, Kind: EdgeCalls, File: "a.go", Line: 3})
	db.SaveEdge(&Edge{ID: 2, FromID: 1, ToID: 3, Kind: EdgeCalls, File: "a.go", Line: 4})
...
func TestClear(t *testing.T) {
	...
	db.SaveNode(&Node{ID: 1, Name: "a", Kind: KindFunc, File: "a.go", Line: 1})
	db.SaveEdge(&Edge{ID: 1, FromID: 1, ToID: 1, Kind: EdgeCalls})
...
func TestFileCountNodeCount(t *testing.T) {
	...
	db.SaveNode(&Node{ID: 1, Name: "a", Kind: KindFunc, File: "a.go", Line: 1})
	db.SaveNode(&Node{ID: 2, Name: "b", Kind: KindFunc, File: "b.go", Line: 1})
...
func TestSearchFTS(t *testing.T) {
	...
	db.SaveNode(&Node{ID: 1, Name: "handleRequest", Kind: KindFunc, File: "a.go", Line: 1, Signature: "func HandleRequest(w http.ResponseWriter, r *http.Request)", Doc: "// HandleRequest processes incoming HTTP requests"})
	db.SaveNode(&Node{ID: 2, Name: "processData", Kind: KindFunc, File: "b.go", Line: 1, Signature: "func processData(data []byte)", Doc: "// processData transforms raw bytes"})
	db.SaveNode(&Node{ID: 3, Name: "MyStruct", Kind: KindStruct, File: "c.go", Line: 1})
...
func TestFTSTriggers(t *testing.T) {
	...
	// INSERT
	db.SaveNode(&Node{ID: 1, Name: "alpha", Kind: KindFunc, File: "a.go", Line: 1, Doc: "// alpha function"})
	...
	// UPDATE
	db.SaveNode(&Node{ID: 1, Name: "beta", Kind: KindFunc, File: "a.go", Line: 1, Doc: "// beta function"})
	nodes, _ = db.SearchFTS("alpha", 10)
	if len(nodes) != 0 {
